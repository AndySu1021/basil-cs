...
// Source: internal/interface/service.go
...
func (m *MockIAuthService) GetClientInfo(ctx context.Context, clientType internal.ClientType) (internal.ClientInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientInfo", ctx, clientType)
	ret0, _ := ret[0].(internal.ClientInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIAuthService) Login(ctx context.Context, username, password string) (internal.ClientInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) Logout(ctx context.Context, userInfo internal.ClientInfo) error {
	m.ctrl.T.Helper()
...
func (m *MockIAuthService) SetClientInfo(clientType internal.ClientType) gin.HandlerFunc {
	m.ctrl.T.Helper()
...
func (m *MockIFastReplyService) ListFastReplyGroup(ctx context.Context) ([]internal.FastReplyGroupItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListFastReplyGroup", ctx)
	ret0, _ := ret[0].([]internal.FastReplyGroupItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIReportService) ListDailyTagReport(ctx context.Context, startDate, endDate time.Time) ([]internal.DailyTagReportColumn, map[string]map[string]int32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListDailyTagReport", ctx, startDate, endDate)
	ret0, _ := ret[0].([]internal.DailyTagReportColumn)
