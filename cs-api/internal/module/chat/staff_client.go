...
func (sc *StaffClient) GetType() internal.ClientType {
	return sc.Type
}
...
func (sc *StaffClient) Reset(clientInfo internal.ClientInfo, manager *ClientManager) error {
	...
	sc.ID = clientInfo.ID
	sc.Type = internal.ClientTypeStaff
