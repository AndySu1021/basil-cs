...
func (w *ClientManager) Register(clientInfo internal.ClientInfo) {
	switch clientInfo.Type {
	case internal.ClientTypeStaff:
	...
	case internal.ClientTypeMember:
...
func (w *ClientManager) Unregister(client Client) error {
	...
	if client.GetType() == internal.ClientTypeStaff {
	...
	} else if client.GetType() == internal.ClientTypeMember {
